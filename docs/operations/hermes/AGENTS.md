...
5. **DeepSeek-only (2026-08-07):** Systemweit NUR `ds/deepseek-v4-flash` (Standard, Think-Max) und `ds/deepseek-v4-pro` (nur echte Komplexität). **KEIN Upstage/OpenRouter — Upstage final entfernt (Pascal 2026-08-10); Embedding: NUR via Nscale (OpenAI-kompatibel `/v1/embeddings`, Modell `Qwen/Qwen3-Embedding-8B`, `NSCALE_SERVICE_TOKEN` — Pascal 2026-08-13); lokale FTS5-Kurzpfade bleiben.** Kein Modell-Call ohne 9Router (`http://127.0.0.1:20128/v1`).
