...
| A20 | ICP Branchen-Landings `/branchen` Top-5 | **shipped** | ICP-HIGH-DEMAND-2026 |
| A21 | Segmented ICP discover + mail | **shipped** | `scripts/gtm/icp_*` |
| A22 | GBP categories per ICP | open | Human Issue |
