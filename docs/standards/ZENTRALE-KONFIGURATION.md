...
| ID | Gap | Status |
|---|---|---|
| OPS-01 | WhatsApp-Bridge: Hermes-native `nexifyai-whatsapp-bridge.service` (Baileys, Port 3000) — **Pairing ✅ 2026-08-08 10:40 (Pascal)**: /health `{"status":"connected"}` (Uptime stabil), Session frisch. **ACHTUNG:** Bridge läuft im self-chat-Modus (bridge.js:113, Default) — verarbeitet NUR Selbst-Chats. WA-TEST-01 (t_b4bbbd39) blocked needs_input: Pascal sendet 4 Testnachrichten; danach M-06 (t_6e059036, P1) Live-Umschaltung. Ban-Risiko Baileys dokumentiert → Cloud-API-Strategie WA-API-01 (Pricing-Recherche 08.08.: Per-Message ab 07/2025, AI-Provider ab 13.05.2026 ohne Non-Template-Gebühr in DE/NL, Service-Message-Gebühr ab 01.10.2026 = Kostenrisiko Dialog). | ⏳ WA-TEST-01 → M-06 |
