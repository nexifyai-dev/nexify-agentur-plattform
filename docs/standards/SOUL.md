...
2. Upstage                →  Embedding (`solar-embedding-1-large`) + Document-AI (Layout/OCR) wo passend — KEINE LLM-Rollen (DeepSeek-only bleibt; Pascal 2026-08-13); sonst keine anderen Modelle systemweit
```
