...
## Normbasis: ISO 27001 A.12.1.4, BSI IT-Grundschutz OPS.1.1.3
...
5. **Real Progress Gate prüfen** (find + wc + git diff)
...
- Rollback-Zeitziel (RTO): < 30 Min (Normal), < 15 Min (Emergency)
...
| Policy | Bezug |
|---|---|
| REAL_PROGRESS_GATE_V1 | Gate prüft Change-Dokumentation |
| BACKUP_RESTORE_DR_POLICY | Backup vor jedem Change |
| INCIDENT_RESPONSE_POLICY | Emergency-Changes aus Incidents |
