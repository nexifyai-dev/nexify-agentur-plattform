...
export function HeroVisual() {
  ...
  // Lime-Redesign 2026-08: SVG-Gradient/Glow + Status-Dot auf #C8FF00
  return (
    <div className="relative mx-auto hidden aspect-square w-full max-w-[540px] select-none lg:block" aria-hidden="true" data-testid="hero-visual">
      <svg viewBox="0 0 540 540" className="h-full w-full">
        <defs>
          <linearGradient id="hv-s" x1="0" y1="0" x2="540" y2="540" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="1" stopColor="#8fce00" />
          </linearGradient>
          <radialGradient id="hv-glow" cx="0.5" cy="0.5" r="0.5">
            <stop offset="0" stopColor="rgba(200,255,0,0.10)" />
        ...
        <g className="orbit-ring" style={{ transformOrigin: "270px 270px" }}>
          <circle cx="270" cy="270" r="235" fill="none" stroke="rgba(200,255,0,0.14)" strokeWidth="1" className="dash-flow" />
        ...
        <g className="orbit-ring-rev" style={{ transformOrigin: "270px 270px" }}>
          <circle cx="270" cy="270" r="172" fill="none" stroke="rgba(200,255,0,0.2)" strokeWidth="1" />
        ...
        <g opacity="0.5">
          <line x1="270" y1="270" x2="270" y2="98" stroke="rgba(200,255,0,0.15)" strokeWidth="1" className="dash-flow" />
          <line x1="270" y1="270" x2="418" y2="356" stroke="rgba(200,255,0,0.15)" strokeWidth="1" className="dash-flow" />
          <line x1="270" y1="270" x2="122" y2="356" stroke="rgba(200,255,0,0.15)" strokeWidth="1" className="dash-flow" />
        </g>
        ...
        <g className="core-pulse">
          ...
          <path d="M270 192 338 231v78l-68 39-68-39v-78l68-39Z" fill="none" stroke="rgba(200,255,0,0.25)" strokeWidth="1" />
      ...
      <div className="float-chip absolute -left-3 top-[18%] flex items-center gap-2.5 rounded-2xl border border-white/15 bg-black/60 px-4 py-3 backdrop-blur-xl">
        ...
        <span className="ml-1 inline-block size-2 rounded-full bg-[#C8FF00] shadow-[0_0_8px_rgba(200,255,0,0.8)]" />
      </div>
