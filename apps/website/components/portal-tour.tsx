...
const STEPS = {
  de: [
    ...
    { icon: CreditCard, title: "Ersten Tagessatz sicher bezahlen", text: "Nach der Annahme können Sie die Anzahlung (1. Arbeitstag, € 449) direkt und sicher über Revolut bezahlen. Ihr Projekt startet damit sofort." },
  ...
  en: [
    ...
    { icon: CreditCard, title: "Pay First Day Rate Securely", text: "After acceptance, you can pay the deposit (1st working day, € 449) directly and securely via Revolut. Your project then starts immediately." },
  ...
  nl: [
    ...
    { icon: CreditCard, title: "Eerste dagtarief veilig betalen", text: "Na acceptatie betaalt u de aanbetaling (1e werkdag, € 449) direct en veilig via Revolut. Uw project start daarmee meteen." },
