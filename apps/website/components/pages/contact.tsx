  ...
  return (
    <main className="pb-10 pt-28 md:pt-36" data-testid="contact-page">
      <div className="site-container">
        ...
        <Reveal delay={80}>
          <div className="glass mt-10 flex flex-col items-stretch justify-between gap-4 p-5 sm:flex-row sm:flex-wrap sm:items-center sm:p-6" data-testid="contact-callback-banner">
