  ...
  home: {
    ...
    pillars: [
      ...
      },
      {
        ...
        text: "449 € netto pro Arbeitstag – während KI-Beratung am deutschen Markt im Schnitt 1.800 € pro Tag kostet. Umfang, Annahmen und Mehrbedarf werden vor der Umsetzung sichtbar gemacht; Sie zahlen nur für dokumentierte Arbeit (Tagesbericht) und behalten jederzeit die volle Kostenkontrolle.",
      },
    ],
  ...
  platform: {
    ...
    blocks: [
      ...
      },
      {
        ...
        points: ["Supabase / PostgreSQL", "REST- & Streaming-APIs", "Authentifizierung & Rollen", "Datenimport-Pipelines", "Backups & Monitoring", "MCP-Integrationen (Model Context Protocol)"],
      },
      {
        icon: "Bot",
        title: "AI & Agenten",
        text: "Produktionsreife AI-Integrationen mit Kontrolle, Protokollen und Freigaben.",
        points: ["OpenRouter-Modell-Routing (DeepSeek u. a.)", "RAG-Wissensanbindung (LightRAG)", "AI-Berater wie NeXify AI", "AgentMemory & Evaluierung", "Guardrails, Logs & Freigaben", "Prompt-Caching & Kostenkontrolle", "Agent-Tracing & Qualitäts-Metriken"],
      },
      {
        icon: "Globe2",
