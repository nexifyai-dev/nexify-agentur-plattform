  ...
  platform: {
    ...
    blocks: [
      ...
      },
      {
        ...
        points: ["Supabase / PostgreSQL", "REST- & streaming-API's", "Authenticatie & rollen", "Data-importpipelines", "Back-ups & monitoring", "MCP-integraties (Model Context Protocol)"],
      },
      {
        icon: "Bot",
        title: "AI & agenten",
        text: "Productierijpe AI-integraties met controle, logging en goedkeuringen.",
        points: ["OpenRouter-modellroutering (DeepSeek e.a.)", "RAG-kenniskoppeling (LightRAG)", "AI-adviseurs zoals NeXify AI", "AgentMemory & evaluatie", "Guardrails, logs & goedkeuringen", "Prompt-caching & kostbeheersing", "Agent-tracing & kwaliteitsmetrieken"],
      },
      {
        icon: "Globe2",
