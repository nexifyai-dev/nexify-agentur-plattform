...
export const metadata: Metadata = {
  title: "NeXify Operator System",
  description: "Die NeXify Operator-Shell verbindet Aufgaben, Agenten, Wissen, Tools, Freigaben und Nachweise in einem kontrollierten Betriebssystem.",
};
          ...
          <div>
            ...
            <Reveal delay={300}>
              <div className="hero-actions">
                <Button asChild size="lg"><Link href="/kontakt">Automatisierung besprechen <ArrowRight className="size-4" /></Link></Button>
              </div>
            </Reveal>
          </div>
