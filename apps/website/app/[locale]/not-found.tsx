...
export default function NotFound() {
  return (
    <main className="grid min-h-[70vh] place-items-center px-5 text-center" data-testid="locale-not-found-page">
      <div>
        ...
        <Button asChild className="mt-8" variant="outline">
          <Link href="/"><ArrowLeft className="size-4" /> Zur Startseite</Link>
        </Button>
      </div>
    </main>
  );
