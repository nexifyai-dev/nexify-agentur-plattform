          ...
          <div>
            ...
            <Reveal delay={300}>
              <div className="hero-actions">
                <Button asChild size="lg"><Link href="/kontakt">Projekt anfragen <ArrowRight className="size-4" /></Link></Button>
                <Button asChild size="lg" variant="outline"><Link href="/preise">Preislogik ansehen</Link></Button>
              </div>
            </Reveal>
          </div>
          <Reveal delay={200}>
      ...
      <section className="site-container pb-8">
        <Reveal>
          <div className="scope-note">
            ...
            <Button asChild size="lg"><Link href="/kontakt">Scope prüfen lassen</Link></Button>
          </div>
        </Reveal>
      </section>
    </main>
